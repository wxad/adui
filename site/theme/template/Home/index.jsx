        ...
        <div className={styles.home}>
          <div className={styles.wrapper}>
            <div className={styles.left}>
              ...
              <p>为 B 端中后台系统界面设计，以简易的基础工具，<br />搭建有秩序的、一致的体验环境。</p>
              <Link to="/docs/start">
                <Button size="large" intent="primary">开始使用</Button>
              </Link>
                  ...
                  <div className={styles.rightInner}>
                    <div className={styles["right-top"]}>
                      <Input
                        ...
                        placeholder=""
                      />
                      <Button.Group size="medium" className={styles.buttonGroup}>
                        {
                    ...
                    <div className={styles["right-medium"]}>
                      <Radio.Group
                        value={radioValue}
                        onChange={param => this.setState({ radioValue: param })}
                        size="medium"
                      ...
                      <Checkbox.Group
                        value={checkboxValue}
                        onChange={param => this.setState({ checkboxValue: param })}
                        size="medium"
                      ...
                      <Switch
                        ...
                        onChange={param => this.setState({ switchChecked: param })}
                      />
                            ...
                            onClick={() => {
                              this.setState(({ count }) => ({
                                ...
                                if (this.state.count % 10 === 0) {
                                  Message.success({ content: "Please use AD UI.😊", icon: "game" })
                                }
                              })
                            }}
                          />
          ...
          <div className={styles.mainWrapper}>
              ...
              <main className={styles.main}>
                <div className={styles.keywords}>
                  <div className={styles.keyword}>
                    <div className={styles["keyword-card"]}><KeyWordSvg0 /></div>
                    <div>
                      <div className={styles["keyword-title"]}>简易</div>
                      <div className={styles["keyword-desc"]}>基础 UI 工具，简单易用</div>
                    </div>
                  </div>
                  <div className={styles.keyword}>
                    <div className={styles["keyword-card"]}><KeyWordSvg1 /></div>
                    <div>
                      <div className={styles["keyword-title"]}>秩序</div>
                      <div className={styles["keyword-desc"]}>设计后台系统的整体体验环境</div>
                    </div>
                  </div>
                  <div className={styles.keyword}>
                    <div className={styles["keyword-card"]}><KeyWordSvg2 /></div>
                    <div>
                      <div className={styles["keyword-title"]}>效率</div>
                      <div className={styles["keyword-desc"]}>开发构建稳定，组件灵活配置</div>
                    </div>
                  </div>
                </div>
                <div className={styles.menu}>
                  ...
                  <Link to="/docs/start">
                    <Card interactive className={styles["menu-card"]}>
                      ...
                      <Icon size={28} icon="arrow-forward" className={styles["menu-card-icon"]} />
                      <div>
                      <div className={styles["menu-card-title"]}>开始使用</div>
                        <div className={styles["menu-card-desc"]}>
                          adui 安装及使用方法。包含按钮、输入框、单选、勾选等 AD UI 组件的各类可配置 Props 及使用方法。
                        </div>
                      </div>
                    </Card>
                    </Link>
                    ...
                    <Card interactive className={styles["menu-card"]}>
                     ...
                     <div className={styles["menu-card-title"]}>组件</div>
                        <div className={styles["menu-card-desc"]}>
                          包含布局、基础、导航、选择、反馈五类 UI 组件的 Playground、常用示例、使用方法及 Props。
                        </div>
                      </div>
                    </Card>
                    </Link>
                    ...
                    <Card interactive className={styles["menu-card"]}>
                      ...
                      <Icon size={28} icon="arrow-forward" className={styles["menu-card-icon"]} />
                      <div>
                     <div className={styles["menu-card-title"]}>图标库</div>
                        <div className={styles["menu-card-desc"]}>
                    ...
                    <Card interactive className={styles["menu-card"]}>
                      ...
                      <Icon size={28} icon="arrow-forward" className={styles["menu-card-icon"]} />
                      <div>
                     <div className={styles["menu-card-title"]}>设计资源</div>
                        <div className={styles["menu-card-desc"]}>
                          设计资源与设计工具下载，目前包含 AD UI Sketch 组件源文件。将持续更新完善。
                        </div>
                      </div>
                    </Card>
                    </Link>
            ...
            <div className={styles.footer}>
              <footer className={styles.wrapper}>
                ...
                <div className={styles["footer-contact"]}>如有任何优化建议，请联系我们：dondondong@tencent.com</div>
              </footer>
            </div>
          </div>
        </div>
