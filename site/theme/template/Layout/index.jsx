...
class SiteLayout extends React.Component {
  ...
  render() {
    ...
    components = components.map(cpn => `${cpn.meta.subtitle} ${cpn.meta.title}`)
                  ...
                  <>
                    <Nav.Group title="视觉语言">
                      <Nav.Item index="principle">
                        <Link to="docs/spec/principle">设计准则 Principle</Link>
                      </Nav.Item>
                  ...
                  <>
                    ...
                    <Nav.Group title="选择类">
                      ...
                      <Nav.Item index="suggest">
                        <Link to="/components/suggest">推荐选择器 Suggest</Link>
                      </Nav.Item>
