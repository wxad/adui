...
import { Slider, Switch, Button, Card } from "../../components"
...
export default class PropertyBox extends React.Component {
  ...
  render() {
    const { size, header, title, subTitle, interactive, elevation } = this.state
      ...
      <div className={styles.wrapper}>
        <div className={styles.property}>
          <div
            ...
            style={{ padding: "40px 90px", backgroundColor: "#fafafa" }}
          >
            <Card
              style={{ flex: 1 }}
              interactive={interactive}
            ...
            <dl className={styles.controls}>
              ...
              <div className={styles.switchControl}>
                <Switch
                  ...
                  unCheckedText="卡片顶栏"
                  checked={header}
                  onChange={(param) => this.setState({ header: param })}
                />
              </div>
              <div className={styles.switchControl}>
                <Switch
              ...
              <div className={styles.switchControl}>
                <Switch
                  ...
                  unCheckedText="副标题"
                  checked={subTitle}
                  onChange={(param) => this.setState({ subTitle: param })}
                />
              </div>
              <div className={styles.switchControl}>
                <Switch
