          ...
          <div className={styles.right}>
            ...
            <dl className={styles.controls}>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          this.setState({ intent: value }, () => {
                            ...
                            // 因此，在这里强行 repaint 一下
                            const theAlert = document.getElementsByClassName("adui-propertyBox-left")[0].getElementsByClassName("adui-alert-base")[0]
              ...
              <div className={styles.switchControl}>
                <Switch checkedText="带标题" unCheckedText="带标题" checked={title} onChange={param => this.setState({ title: param })} />
              </div>
              <div className={styles.switchControl}>
                <Switch checkedText="可关闭" unCheckedText="可关闭" checked={closable} onChange={param => {
              ...
              <div className={styles.switchControl}>
                <Switch checkedText="可展开" unCheckedText="可展开" checked={expand} onChange={param => {
              ...
              <div className={styles.switchControl}>
                <Switch checkedText="自定义图标" unCheckedText="自定义图标" checked={icon} onChange={param => this.setState({ icon: param })} />
              </div>
              <div className={styles.switchControl}>
