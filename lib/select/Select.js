...
var Select = function (_React$Component) {
  ...
  function Select(props) {
        ...
        setTimeout(function () {
          if (_this.search) {
            if (value) {
              ...
              if (!selectId) {
                var _ref, _this$search$parentNo;

                id = (_ref = (_this$search$parentNo = _this.search.parentNode) === null || _this$search$parentNo === void 0 ? void 0 : _this$search$parentNo.nextSibling) === null || _ref === void 0 ? void 0 : _ref.id;
    ...
    _this.handleSearch = function (e) {
      ...
      if (_this.select) {
        ...
        if (!selectId) {
          var _ref2, _e$target$parentNode;

          id = (_ref2 = (_e$target$parentNode = e.target.parentNode) === null || _e$target$parentNode === void 0 ? void 0 : _e$target$parentNode.nextSibling) === null || _ref2 === void 0 ? void 0 : _ref2.id;
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      return React.createElement(_configProvider.ConfigContext.Consumer, null, function (_ref3) {
        var _classNames;

        var getPopupContainerContext = _ref3.getPopupContainer;
...
Select.getDerivedStateFromProps = function (_ref4) {
  var open = _ref4.open,
      value = _ref4.value;
  var newState = {};
