...
var confirm = function confirm(config) {
  ...
  function onClose(cb) {
    currentConfig = _objectSpread({}, currentConfig, {
      afterClose: afterClose,
      visible: false
    });
  ...
  function update(newConfig) {
    currentConfig = _objectSpread({}, currentConfig, {}, newConfig);
    render(currentConfig);
  }
